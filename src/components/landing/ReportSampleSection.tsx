        ...
        <div className="mt-12 grid grid-cols-1 gap-10 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-7">
            ...
            <svg viewBox="0 0 400 200" className="w-full" xmlns="http://www.w3.org/2000/svg">
              ...
              <polyline fill="none" stroke="#6366F1" strokeWidth="2" strokeLinejoin="round" points="20,140 60,130 100,120 140,100 180,110 220,85 260,90 300,70 340,75 380,60" />
              <polygon fill="url(#grad)" points="20,140 60,130 100,120 140,100 180,110 220,85 260,90 300,70 340,75 380,60 380,200 20,200" />
              <defs>
