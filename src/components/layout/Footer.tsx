      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1 lg:col-start-1">
            ...
            <p className="mt-3 text-sm text-gray-500 leading-relaxed">
              Research reports for stocks, crypto, and futures — generated in
              minutes with 50+ cited sources.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <p className="mt-2 text-xs text-gray-400">
            Disclaimer: AI Market Pulse provides research and analysis for
            informational purposes only. This is not financial advice. Always do
